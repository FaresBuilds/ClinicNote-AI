...
- a polished combined PDF containing the transcript and both reports.
...
Generated audio, transcripts, text reports, and PDF reports are saved under `data/`. This is an educational demonstration, not a production healthcare system.
